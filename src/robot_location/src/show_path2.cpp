...
ros::Subscriber odomSub;
 ...
 void odomCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& odom)
 {
...
int main (int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    path_pub = nh.advertise<nav_msgs::Path>("path_odom_combined",10, true);
    odomSub  = nh.subscribe<geometry_msgs::PoseWithCovarianceStamped>("/odom_combined", 10, odomCallback);
